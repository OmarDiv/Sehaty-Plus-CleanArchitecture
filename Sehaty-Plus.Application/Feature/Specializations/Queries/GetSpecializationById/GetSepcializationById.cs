...
public class GetSpecializtionByIdHandler(IUnitOfWork _unitOfWork, ICacheService _cacheService) : IRequestHandler<GetSpecializationById, Result<SpecializationResponse>>
{
