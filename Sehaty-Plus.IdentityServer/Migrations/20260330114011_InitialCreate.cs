        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Latitude = table.Column<decimal>(type: "decimal(12,10)", precision: 12, scale: 10, nullable: true),
                    Longitude = table.Column<decimal>(type: "decimal(12,10)", precision: 12, scale: 10, nullable: true),
                    PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Specialization_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Specialization_AspNetUsers_UpdatedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Specialization_CreatedById",
                table: "Specialization",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_Specialization_UpdatedById",
                table: "Specialization",
                column: "UpdatedById");
        }
